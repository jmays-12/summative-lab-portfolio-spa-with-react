...
export const themes = {
    ...
    retro: {
        ...
        bg: "bg-retro",
        surface: "bg-[#FFF7F0]",
        borderFull: "border-4 border-[#2D1B69]",
        borderColor: "border-[#2D1B69]",
        divide: "divide-[#2D1B69]",
        heading: "text-[#2D1B69]",
        text: "text-[#1F2937]",
        textSecondary: "text-[#6B7280]",
        accent: "text-[#F43F8E]",
        input: "bg-white border-2 border-[#2D1B69] text-[#1F2937] placeholder-[#9CA3AF] focus:border-[#00C2A8]",
        button: "border-2 border-[#2D1B69] bg-[#F9D34C] hover:bg-[#FF8FAB] text-[#2D1B69] focus-visible:ring-2 focus-visible:ring-[#00C2A8] focus-visible:outline-none",
        rounded: "rounded-none",
        roundedControl: "rounded-none",
        shadow: "shadow-[6px_6px_0_0_#2D1B69]",
        font: "font-[Tahoma]",
        error: "text-[#E63946]",
    },
